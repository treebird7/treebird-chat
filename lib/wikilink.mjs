...
function _resolve(link, opts) {
  ...
  if (!path) return { path: null, type: 'missing', active: false, anchor };
...
function resolveMem(slug, anchor) {
  ...
  const candidates = [
    join(home, '.claude', 'projects', '-Users-freedbird-Dev-memosan', 'memory', `${slug}.md`),
    join(home, '.claude', 'projects', '-Users-freedbird-Dev-Toak', 'memory', `${slug}.md`),
  ];
